...
I am investigating and for now am inactivating the settings.
...
```
Note: You may try to the following setting once you have a
stable setup going but I consider it to be unstable at this
time.
```
